...
ALTER TABLE modules ADD COLUMN IF NOT EXISTS module_type text DEFAULT 'mixed'
  CHECK (module_type IN ('theory', 'math', 'programming', 'language', 'project', 'mixed'));
...
COMMENT ON COLUMN modules.module_type IS 'Determines which learning methods the Decision Engine recommends';
