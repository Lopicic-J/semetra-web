...
const TIER_COLORS = {
  ...
  silver:  { bg: "bg-slate-100",  text: "text-slate-600",  ring: "ring-slate-300",  gradient: "from-slate-400 to-slate-500" },
  ...
  return (
    <ErrorBoundary feature="Achievements">
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <p className="text-surface-500 text-sm mt-1">{t("achievements.subtitle")}</p>
      </div>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {recentUnlocks.map(a => {
              ...
              return (
                <div key={a.id} className={`card p-4 border-l-4 border-yellow-400 bg-gradient-to-r from-yellow-50 to-white`}>
      ...
      <Link href="/leaderboard">
        <div className="card bg-gradient-to-r from-brand-50 to-indigo-50 border-brand-200 cursor-pointer hover:shadow-md transition-shadow mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Medal className="text-brand-500" size={20} />
              <div>
                <h3 className="font-semibold text-surface-900 text-sm">{t("achievements.viewLeaderboard") || "Bestenliste anzeigen"}</h3>
                <p className="text-xs text-surface-500">Vergleiche deine Punkte mit anderen</p>
              </div>
            </div>
          ...
          return (
            <div
              ...
              className={`card p-4 transition-all ${
                a.unlocked
                  ? "border-yellow-200 bg-gradient-to-br from-white to-yellow-50/50"
                  : "opacity-70"
              }`}
            >
              <div className="flex items-start gap-3">
