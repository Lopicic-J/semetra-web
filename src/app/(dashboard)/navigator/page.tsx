...
function getFeatures(t: (k: string) => string): Feature[] {
  return [
    ...
    { href: "/calendar", icon: Calendar, label: "Kalender", group: "planning",
    ...
    // Lernen
    { href: "/timer", icon: Timer, label: "Lernzeit & Timer", group: "learning",
    ...
    { href: "/notes", icon: FileText, label: "Materialien", group: "learning",
    ...
    { href: "/groups", icon: Brain, label: "Lerngruppen", group: "learning",
    ...
    { href: "/flashcards", icon: Layers, label: "Karteikarten", group: "learning",
    ...
    { href: "/knowledge", icon: Brain, label: "Lernziele", group: "learning",
