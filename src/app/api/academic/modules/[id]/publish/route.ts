...
export async function POST(
  ...
  try {
    ...
    if (publishError) {
      console.error("[academic/modules/[id]/publish POST]", publishError);
    ...
    if (fetchError) {
      console.error("[academic/modules/[id]/publish GET updated]", fetchError);
    ...
    console.error("[academic/modules/[id]/publish POST]", err);
    return NextResponse.json(
