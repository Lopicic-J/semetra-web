    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-50 to-indigo-50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Dein smarter FH-Studienplaner</p>
        </div>
        ...
        <div className="card">
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            Noch kein Konto?{" "}
            <Link href="/register" className="text-violet-600 font-medium hover:underline">Registrieren</Link>
          </p>
        </div>
      </div>
    </div>
