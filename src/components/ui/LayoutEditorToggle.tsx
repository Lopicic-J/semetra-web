  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 flex items-center gap-2">
      {editing && (
        <button
          onClick={resetLayout}
          className="flex items-center gap-2 px-3 py-2 bg-surface-100 dark:bg-surface-800 text-surface-600 dark:text-surface-300 rounded-xl shadow-lg border border-surface-200 dark:border-surface-700 hover:bg-surface-200 dark:hover:bg-surface-700 transition-all text-[12px] font-medium"
