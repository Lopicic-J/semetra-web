...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary: "bg-surface-100 text-surface-700 border border-surface-200/60 hover:bg-surface-200/70 hover:text-surface-800 focus-visible:ring-surface-400 dark:bg-surface-800 dark:text-surface-300 dark:border-surface-700",
